    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string e, string t)
        {
            ...
            try
            {
                ...
                {
                    EEmailVerifyStatus.VerifiedSucceeded => Ok(new {
                        status = EEmailVerifyStatus.VerifiedSucceeded, 
                        message = "Account has been activated." 
                    }),
                    EEmailVerifyStatus.VerifiedFailed => BadRequest(new {
                        status = EEmailVerifyStatus.VerifiedFailed, 
